  ...
  return (
    ...
    >
      <div className="space-y-4 pb-20">
            ...
            <CardContent className="p-4 relative">
              <div className="flex flex-col items-center justify-center text-center space-y-2">
                ...
                <div className="w-full">
                  ...
                  <p className="text-[10px] text-muted-foreground">38/42 rooms</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4 relative">
              <div className="flex flex-col items-center justify-center text-center space-y-2">
                ...
                <div className="w-full">
                  ...
                  <p className="text-[10px] text-muted-foreground">4 tenants</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-purple-200 overflow-hidden relative" data-testid="card-revenue-chart-mobile">
          <div className="absolute inset-0 bg-gradient-to-br from-purple-50 to-blue-50 opacity-0 group-hover:opacity-100 transition-opacity" />
          ...
          <CardContent className="relative">
            <div className="space-y-3">
              {revenueData.map((item) => (
                <div key={item.month} className="space-y-1" data-testid={`chart-bar-${item.month}-mobile`}>
        ...
        <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-purple-200 overflow-hidden relative" data-testid="card-report-generator-mobile">
          ...
          <CardContent className="space-y-3 relative">
            <div className="space-y-2">
              <label className="text-xs font-medium" htmlFor="report-type-mobile">
                Report Type
              </label>
              <Select defaultValue="revenue">
                <SelectTrigger id="report-type-mobile" className="h-10 text-sm" data-testid="select-report-type-mobile">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="revenue" data-testid="option-revenue-mobile">
                    Revenue Report
                  </SelectItem>
                  <SelectItem value="payment" data-testid="option-payment-mobile">
                    Payment History
                  </SelectItem>
                  <SelectItem value="occupancy" data-testid="option-occupancy-mobile">
                    Occupancy Summary
                  </SelectItem>
                  <SelectItem value="expense" data-testid="option-expense-mobile">
                    Expense Breakdown
                  </SelectItem>
                </SelectContent>
              </Select>
            ...
            <div className="space-y-2">
              <label className="text-xs font-medium" htmlFor="date-range-mobile">
                Date Range
              </label>
              <input 
                id="date-range-mobile"
                type="month" 
                className="w-full h-10 px-3 text-sm border border-border rounded-lg bg-card text-foreground focus:outline-none focus:ring-2 focus:ring-purple-500" 
                data-testid="input-date-range-mobile"
              />
            </div>
            <Button 
              className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white gap-2 h-10"
        ...
        <div className="space-y-3">
          ...
          <Card className="group hover:shadow-lg transition-all duration-300 border-2 border-transparent hover:border-purple-200 overflow-hidden relative" data-testid="card-recent-activity-mobile">
            <div className="absolute inset-0 bg-gradient-to-br from-purple-50 to-blue-50 opacity-0 group-hover:opacity-100 transition-opacity" />
            <CardHeader className="relative pb-3">
              <div className="flex items-center gap-2">
